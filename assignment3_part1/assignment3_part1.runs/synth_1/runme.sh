...
HD_PWD='/home/plee304/3220_a3part1/3220_a3/assignment3_part1/assignment3_part1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project3_frame.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project3_frame.tcl
